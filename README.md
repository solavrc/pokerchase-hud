...
- **プレイヤー別の詳細表示**: ポジション別統計と、最近のハンドをHUDから確認できます。直近ハンドは表示件数を10・25・50・100件から選べ（選択は端末ごとに保存されます）、そのプレイヤーが実際に配られたハンドだけを、ショーダウンで公開されたホールカード・プリフロップのライン・フロップ以降のアクションとあわせて一覧します。
